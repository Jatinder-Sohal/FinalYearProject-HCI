...
<body>
  ...
  <div class="text-center" style = "position:absolute; left:37%; top:15%;">
  	<h1>Financial </h1>
  	<h1>Tracker</h1>
  ...
  <div class="row row-cols-1 row-cols-md-3 g-4" style = "position:absolute; left:550px; top:550px;  max-height: 18rem;">

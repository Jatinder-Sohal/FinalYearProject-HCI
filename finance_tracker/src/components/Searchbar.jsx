...
function Searchbar() {
    return (
        <div className="custom-header">
            ...
            <input className="search" placeholder="Enter a forum enquiry here!" />  
            ...
            <div className="custom-row">
                <div className="col-sm-4" style={{ maxWidth: "25rem", padding: "0 10px" }}>
                    <div className="card">
                        <div className="card-body">
                            <h5 className="card-title">Start a live chat</h5>
                ...
                <div className="col-sm-4" style={{ maxWidth: "25rem", padding: "0 10px" }}>
                    <div className="card">
                        <div className="card-body">
                            <h5 className="card-title">Check out the forum</h5>
